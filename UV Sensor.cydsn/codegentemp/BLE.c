...
{
    0x0640u,    /* uint16 advertising_interval_min */
    0x0640u,    /* uint16 advertising_interval_max */
    CYBLE_GAPP_NON_CONNECTABLE_UNDIRECTED_ADV, /* uint8 advertising_type */
